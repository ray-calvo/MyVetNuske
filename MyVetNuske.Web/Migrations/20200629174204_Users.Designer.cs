...
namespace MyVetNuske.Web.Migrations
{
    ...
    [Migration("20200629174204_Users")]
    partial class Users
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyVetNuske.Web.Data.Entities.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyVetNuske.Web.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyVetNuske.Web.Data.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("MyVetNuske.Web.Data.Entities.Manager", b =>
                {
                    b.HasOne("MyVetNuske.Web.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
